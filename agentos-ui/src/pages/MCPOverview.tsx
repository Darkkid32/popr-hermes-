  ...
  return (
    <div className="page-body">
      <div className="status-pills" style={{ paddingLeft: 0, paddingRight: 0 }}>
        <span className="badge badge-green"><span className="dot dot-green" /> {connectedCount} connected</span>
        <span className="badge badge-gray"><span className="mono">{disconnectedCount} disconnected</span></span>
        <span className="badge badge-red"><span className="mono">{errorCount} errors</span></span>
        <span className="badge badge-cyan"><span className="mono">{MCP_SERVERS.length} servers · {totalTools} tools · {totalRequests.toLocaleString()} requests</span></span>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 12, marginBottom: 20 }}>
        <div className="col-stack">
          <div className="panel">
            <div className="section-label"><span className="ico">⬢</span> CONNECTED SERVERS · {MCP_SERVERS.length}</div>
          ...
          <div className="panel">
            <div className="section-label"><span className="ico">✦</span> TOOLS BY CATEGORY</div>
        ...
        <div className="col-stack">
          ...
          <div className="panel">
            <div className="section-label"><span className="ico">∿</span> REQUEST VOLUME</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {MCP_SERVERS
