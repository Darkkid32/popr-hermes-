...
const AUDIT_LOGS_DATA = [
  { id: '1', timestamp: '2026-07-15 14:32:18', actor: 'Sarah Chen', actorId: 'user-1', action: 'api_key.rotate', resource: 'api_key', resourceId: 'key-prod-abc123', detail: 'Rotated production API key', ip: '192.168.1.100', status: 'success', severity: 'info', color: '#ff4d6d' },
  { id: '2', timestamp: '2026-07-15 14:30:45', actor: 'Marcus Johnson', actorId: 'user-2', action: 'secret.rotate', resource: 'secret', resourceId: 'secret/db-password', detail: 'Rotated database password', ip: '10.0.0.50', status: 'success', severity: 'info', color: '#7c6cf5' },
  { id: '3', timestamp: '2026-07-15 10:15:22', actor: 'Security System', actorId: 'system', action: 'threat.detected', resource: 'threat', resourceId: 'threat-001', detail: 'Brute force attack from 203.0.113.45', ip: '203.0.113.45', status: 'blocked', severity: 'error', color: '#ff4d6d' },
  { id: '4', timestamp: '2026-07-15 09:22:10', actor: 'Alex Rivera', actorId: 'user-3', action: 'policy.update', resource: 'policy', resourceId: 'policy-password', detail: 'Updated password policy: min 12 chars', ip: '10.0.0.75', status: 'success', severity: 'info', color: '#d946ef' },
  { id: '5', timestamp: '2026-07-14 16:45:33', actor: 'Priya Patel', actorId: 'user-4', action: 'certificate.renew', resource: 'certificate', resourceId: 'cert-hermes.ai', detail: 'Renewed wildcard certificate for *.hermes.ai', ip: '10.0.0.75', status: 'success', severity: 'info', color: '#00e5ff' },
  { id: '6', timestamp: '2026-07-14 14:20:11', actor: 'System', actorId: 'system', action: 'session.revoke', resource: 'session', resourceId: 'sess-005', detail: 'Revoked suspicious session from 203.0.113.45', ip: '203.0.113.45', status: 'success', severity: 'warning', color: '#ffb347' },
  { id: '7', timestamp: '2026-07-14 11:30:00', actor: 'James Wilson', actorId: 'user-5', action: 'vulnerability.scan', resource: 'scan', resourceId: 'scan-weekly-20260714', detail: 'Completed weekly vulnerability scan', ip: 'internal', status: 'success', severity: 'info', color: '#ff4d6d' },
  { id: '8', timestamp: '2026-07-13 19:45:22', actor: 'Emily Davis', actorId: 'user-6', action: 'user.mfa.enable', resource: 'user', resourceId: 'user-7', detail: 'Enabled MFA for David Kim', ip: '10.0.0.80', status: 'success', severity: 'info', color: '#ffb347' },
  { id: '9', timestamp: '2026-07-13 15:30:45', actor: 'System', actorId: 'system', action: 'compliance.check', resource: 'compliance', resourceId: 'soc2-type2', detail: 'SOC 2 Type II compliance check passed', ip: 'internal', status: 'success', severity: 'info', color: '#7c6cf5' },
  { id: '10', timestamp: '2026-07-13 11:20:18', actor: 'Security System', actorId: 'system', action: 'threat.contained', resource: 'threat', resourceId: 'threat-002', detail: 'Contained data exfiltration attempt', ip: '198.51.100.23', status: 'success', severity: 'info', color: '#22d97a' },
  { id: '11', timestamp: '2026-07-12 22:15:30', actor: 'System', actorId: 'system', action: 'login.failed', resource: 'auth', resourceId: 'login-404', detail: '5 failed login attempts for user-12', ip: '203.0.113.45', status: 'blocked', severity: 'error', color: '#ff4d6d' },
  { id: '12', timestamp: '2026-07-12 16:50:12', actor: 'Sarah Chen', actorId: 'user-1', action: 'api_key.create', resource: 'api_key', resourceId: 'key-partner-pqr', detail: 'Created API key for external partner', ip: '192.168.1.100', status: 'success', severity: 'info', color: '#ff4d6d' },
  { id: '13', timestamp: '2026-07-12 14:30:00', actor: 'Alex Rivera', actorId: 'user-3', action: 'secret.create', resource: 'secret', resourceId: 'secret/slack-webhook', detail: 'Added Slack webhook secret', ip: '10.0.0.75', status: 'success', severity: 'info', color: '#d946ef' },
  { id: '14', timestamp: '2026-07-11 14:20:55', actor: 'Priya Patel', actorId: 'user-4', action: 'certificate.request', resource: 'certificate', resourceId: 'cert-dev.hermes.local', detail: 'Requested certificate for dev environment', ip: '10.0.0.75', status: 'success', severity: 'info', color: '#00e5ff' },
  { id: '15', timestamp: '2026-07-11 12:00:33', actor: 'System', actorId: 'system', action: 'backup.complete', resource: 'backup', resourceId: 'backup-prod-20260711', detail: 'Completed encrypted backup of production', ip: 'internal', status: 'success', severity: 'info', color: '#7c6cf5' },
  { id: '16', timestamp: '2026-07-11 09:15:44', actor: 'Marcus Johnson', actorId: 'user-2', action: 'session.revoke', resource: 'session', resourceId: 'sess-007', detail: 'Revoked expired session for David Kim', ip: '10.0.0.50', status: 'success', severity: 'info', color: '#7c6cf5' },
  ...
  { id: '20', timestamp: '2026-07-09 13:30:11', actor: 'Priya Patel', actorId: 'user-4', action: 'vulnerability.remediate', resource: 'vulnerability', resourceId: 'cve-2026-1234', detail: 'Applied patch for CVE-2026-1234', ip: '10.0.0.75', status: 'success', severity: 'info', color: '#00e5ff' },
]

const ACTION_OPTIONS = [
  { value: '', label: 'All Actions' },
  { value: 'api_key.create', label: 'API Key Create' },
  { value: 'api_key.rotate', label: 'API Key Rotate' },
  ...
  { value: 'certificate.renew', label: 'Certificate Renew' },
  { value: 'policy.update', label: 'Policy Update' },
  { value: 'user.mfa.enable', label: 'MFA Enable' },
  { value: 'session.revoke', label: 'Session Revoke' },
  { value: 'threat.detected', label: 'Threat Detected' },
  { value: 'threat.contained', label: 'Threat Contained' },
  { value: 'vulnerability.scan', label: 'Vulnerability Scan' },
  { value: 'vulnerability.remediate', label: 'Vulnerability Remediate' },
