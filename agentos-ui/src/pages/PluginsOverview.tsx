  ...
  return (
    <div className="page-body">
      <StatusPills pills={[
        ...
        { label: <><span className="mono">{PLUGINS.length} installed · {categories} categories</span></>, tone: 'cyan' },
      ]} />

      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 12, marginBottom: 20 }}>
        <div className="col-stack">
          <div className="panel">
                      <SectionLabel icon="⊕">INSTALLED PLUGINS · {PLUGINS.length}</SectionLabel>
                    ...
                    <div className="panel">
                      <SectionLabel icon="⌘">PLUGIN CATEGORIES</SectionLabel>
                  ...
                  <div className="col-stack">
                    ...
                    <div className="panel">
                      <SectionLabel icon="⚠">PERMISSIONS SUMMARY</SectionLabel>
